...
class TenancyServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Configure tenancy middleware to use X-Tenant-ID header and tenant query parameter only
        \Stancl\Tenancy\Middleware\InitializeTenancyByRequestData::$header = 'X-Tenant-ID';
        \Stancl\Tenancy\Middleware\InitializeTenancyByRequestData::$queryParameter = 'tenant';
    ...
    protected function makeTenancyMiddlewareHighestPriority()
    {
        $tenancyMiddleware = [
            ...
            \App\Http\Middleware\CustomInitializeTenancyByRequestData::class,
        ];
